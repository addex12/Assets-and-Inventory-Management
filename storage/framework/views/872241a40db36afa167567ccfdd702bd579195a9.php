...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title"><?php echo e(trans('admin/manufacturers/table.create')); ?></h2>
        </div>
        <div class="modal-body">
            <form action="<?php echo e(route('api.manufacturers.store')); ?>" onsubmit="return false">
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/modals/manufacturer.blade.php ENDPATH**/ ?>
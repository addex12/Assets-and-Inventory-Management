...
<div class="modal fade" id="uploadFileModal" tabindex="-1" role="dialog" aria-labelledby="uploadFileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form
                method="POST"
                action="<?php echo e(route('upload/' . $item_type, $item_id)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'b755fd58408e5b8e1a655ca0e3e17e80::input.textarea','data' => ['name' => 'notes','value' => old('notes'),'placeholder' => 'Notes (Optional)','rows' => '3','ariaLabel' => 'file']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/modals/upload-file.blade.php ENDPATH**/ ?>
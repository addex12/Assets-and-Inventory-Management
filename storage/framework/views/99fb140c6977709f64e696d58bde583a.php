...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'b755fd58408e5b8e1a655ca0e3e17e80::redirect_submit_options','data' => ['indexRoute' => $index_route ?? null,'buttonLabel' => trans('general.save'),'options' => $options ?? []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>

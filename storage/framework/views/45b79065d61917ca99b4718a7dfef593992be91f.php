                        ...
                        <td style="<?php echo e($style['email-masthead']); ?>">
                            ...
                            <?php if(($snipeSettings->show_images_in_email=='1' ) && ($snipeSettings::setupCompleted())): ?>
                                ...
                                <?php if($snipeSettings->brand == '3'): ?>
                                    <?php if($logo!=''): ?>
                                        <img class="navbar-brand-img logo" style="max-width: 50px;" src="<?php echo e(config('app.url')); ?>/uploads/<?php echo e($logo); ?>">
                                    <?php endif; ?>
                            ...
                            <table style="<?php echo e($style['email-body_inner']); ?>" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <!-- Salutation -->
                                        <p style="<?php echo e($style['paragraph']); ?>">
                                            Regards,<br><?php echo e($snipeSettings->site_name); ?>
                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                            ...
                                            <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(config('app.url')); ?>" target="_blank"><?php echo e($snipeSettings->site_name); ?></a>.
                                            <?php echo e(trans('mail.rights_reserved')); ?>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>
                            ...
                            <div class="col-md-12 table-responsive" style="padding-top: 30px;">
                                <table data-pagination="true"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currentFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    		...
                                    		<tr style="<?php echo e(($this->activeFile && ($currentFile->id == $this->activeFile->id)) ? 'font-weight: bold' : ''); ?>" class="<?php echo e(($this->activeFile && ($currentFile->id == $this->activeFile->id)) ? 'warning' : ''); ?>">
                                    			<td><?php echo e($currentFile->file_path); ?></td>
                                    			<td><?php echo e(Helper::getFormattedDateObject($currentFile->created_at, 'datetime', false)); ?></td>
                                                <td><?php echo e(($currentFile->adminuser) ? $currentFile->adminuser->present()->fullName : '--'); ?></td>
                                                    ...
                                                    <td colspan="5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-xs-12">
                                                                    <?php echo e(Form::select('typeOfImport', $importTypes, $typeOfImport, [
                                                                        'id' => 'import_type',
                                                            ...
                                                            <div class="form-group col-md-9 col-md-offset-3">
                                                                <label class="form-control">
                                                                    <input type="checkbox" name="update" data-livewire-component="<?php echo e($this->getId()); ?>" wire:model.live="update">
                                                                ...
                                                                <!--[if BLOCK]><![endif]--><?php if(($typeOfImport != 'location' && $typeOfImport!= 'assetModel') && ($typeOfImport!='')): ?>
                                                                <label class="form-control">
                                                                    <input type="checkbox" name="send_welcome" data-livewire-component="<?php echo e($this->getId()); ?>" wire:model.live="send_welcome">
                                                                ...
                                                                <label class="form-control">
                                                                    <input type="checkbox" name="run_backup" data-livewire-component="<?php echo e($this->getId()); ?>" wire:model.live="run_backup">
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php if($typeOfImport): ?>
                                                                    ...
                                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $headerRow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="form-group col-md-12" wire:key="header-row-<?php echo e($index); ?>">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <?php echo e(Form::select('field_map.'.$index, $columnOptions[$typeOfImport], @$field_map[$index],
                                                                                    [
									                                    ...
									                                    <!--[if BLOCK]><![endif]--><?php if(($this->activeFile->first_row) && (array_key_exists($index, $this->activeFile->first_row))): ?>
                                                                            <div class="col-md-5">
                                                                                <p class="form-control-static"><?php echo e(str_limit($this->activeFile->first_row[$index], 50, '...')); ?></p>
                                                                            </div>
                                                                        <?php else: ?>
                                                                            <?php
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <div class="col-md-3 text-left">
                                                                        <a href="#" wire:click.prevent="$set('activeFileId',null)"><?php echo e(trans('general.cancel')); ?></a>
                                                                    </div>
                                                                    <div class="col-md-9">
                                                                        <button type="submit" class="btn btn-primary col-md-5" id="import"><?php echo e(trans('admin/hardware/message.import.import_button')); ?></button>
                                                                        <br><br>
                                                                    </div>
                                                                </div>
    ...
    <script>
        ...
        $('#fileupload').fileupload({
            dataType: 'json',
                ...
                $wire.$set('progress_message', '<i class="fas fa-check faa-pulse animated"></i> <?php echo e(trans('general.notification_success')); ?>');
            ...
            fail: function() {
                ...
                $wire.$set('progress', 100);
                $wire.$set('progress_message', '<i class="fas fa-exclamation-triangle faa-pulse animated"></i> <?php echo e(trans('general.upload_error')); ?>');
            }
        })
        ...
        $(function () {
            ...
            $('#upload-table').on('click', '#import', function () {
                ...
                $wire.$set('statusText', '<i class="fa fa-spinner fa-spin" aria-hidden="true"></i> <?php echo e(trans('admin/hardware/form.processing_spinner')); ?>');
                $wire.generate_field_map().then(function (mappings_raw) {
                    ...
                    $.post({
                        ...
                        $wire.$set('statusText', "<?php echo e(trans('general.success_redirecting')); ?>");
                        // console.dir(body)
                        ...
                        // notifications could be sent".
                            ...
                            if ((body) && (error in body)) {
                                ...
                                $wire.$set('message', "<?php echo e(trans('general.importer_generic_error')); ?>");
                            }

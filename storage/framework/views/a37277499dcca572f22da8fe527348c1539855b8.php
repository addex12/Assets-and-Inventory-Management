        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <div class="panel box box-default">
                <div class="box-header with-border">
                    <h2 class="box-title">
                        <i class="fas fa-sitemap"></i> <?php echo e(trans('admin/settings/general.ldap_ad')); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="form-control">
                                <?php echo e(Form::checkbox('is_ad', '1', Request::old('is_ad', $setting->is_ad), [((config('app.lock_passwords')===true)) ? 'disabled ': '', 'class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="form-control">
                                <?php echo e(Form::checkbox('ldap_pw_sync', '1', Request::old('ldap_pw_sync', $setting->ldap_pw_sync), [((config('app.lock_passwords')===true)) ? 'disabled ': '', 'class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ad_domain') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ad_domain', Request::old('ad_domain', $setting->ad_domain), ['class' => 'form-control','placeholder' => trans('general.example') .'example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_client_tls_key') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::textarea('ldap_client_tls_key', Request::old('ldap_client_tls_key', $setting->ldap_client_tls_key), ['class' => 'form-control','placeholder' =>  trans('general.example') .'-----BEGIN RSA PRIVATE KEY-----'."\r\n1234567890\r\n-----END RSA PRIVATE KEY-----
", $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_client_tls_cert') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::textarea('ldap_client_tls_cert', Request::old('ldap_client_tls_cert', $setting->ldap_client_tls_cert), ['class' => 'form-control','placeholder' =>  trans('general.example') .'-----BEGIN CERTIFICATE-----'."\r\n1234567890\r\n-----END CERTIFICATE-----", $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_server') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_server', Request::old('ldap_server', $setting->ldap_server), ['class' => 'form-control','placeholder' =>  trans('general.example') .'ldap://ldap.example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="form-control">
                                    <?php echo e(Form::checkbox('ldap_tls', '1', Request::old('ldap_tls', $setting->ldap_tls),['class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_server_cert_ignore') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <label class="form-control">
                                    <?php echo e(Form::checkbox('ldap_server_cert_ignore', '1', Request::old('ldap_server_cert_ignore', $setting->ldap_server_cert_ignore),['class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_uname') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_uname', Request::old('ldap_uname', $setting->ldap_uname), ['class' => 'form-control','autocomplete' => 'off', 'placeholder' => trans('general.example') .'binduser@example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_basedn') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_basedn', Request::old('ldap_basedn', $setting->ldap_basedn), ['class' => 'form-control', 'placeholder' => trans('general.example') .'cn=users/authorized,dc=example,dc=com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_filter') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_filter', Request::old('ldap_filter', $setting->ldap_filter), ['class' => 'form-control','placeholder' => trans('general.example') .'&(cn=*)', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_username_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_username_field', Request::old('ldap_username_field', $setting->ldap_username_field), ['class' => 'form-control','placeholder' => trans('general.example') .'samaccountname', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_lname_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_lname_field', Request::old('ldap_lname_field', $setting->ldap_lname_field), ['class' => 'form-control','placeholder' => trans('general.example') .'sn', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_fname_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_fname_field', Request::old('ldap_fname_field', $setting->ldap_fname_field), ['class' => 'form-control', 'placeholder' => trans('general.example') .'givenname', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_auth_filter_query') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_auth_filter_query', Request::old('ldap_auth_filter_query', $setting->ldap_auth_filter_query), ['class' => 'form-control','placeholder' => trans('general.example') .'uid=', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_active_flag') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_active_flag', Request::old('ldap_active_flag', $setting->ldap_active_flag), ['class' => 'form-control', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_emp_num') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_emp_num', Request::old('ldap_emp_num', $setting->ldap_emp_num), ['class' => 'form-control','placeholder' => trans('general.example') .'employeenumber/employeeid', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_dept') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_dept', Request::old('ldap_dept', $setting->ldap_dept), ['class' => 'form-control','placeholder' => trans('general.example') .'department', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_dept') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_manager', Request::old('ldap_manager', $setting->ldap_manager), ['class' => 'form-control','placeholder' => trans('general.example') .'manager', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_email') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_email', Request::old('ldap_email', $setting->ldap_email), ['class' => 'form-control','placeholder' => trans('general.example') .'mail', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_phone') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_phone', Request::old('ldap_phone', $setting->ldap_phone_field), ['class' => 'form-control','placeholder' => trans('general.example') .'telephonenumber', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_jobtitle') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_jobtitle', Request::old('ldap_jobtitle', $setting->ldap_jobtitle), ['class' => 'form-control','placeholder' => trans('general.example') .'title', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_country') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_country', Request::old('ldap_country', $setting->ldap_country), ['class' => 'form-control','placeholder' => trans('general.example') .'c', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_location') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('ldap_location', Request::old('ldap_location', $setting->ldap_location), ['class' => 'form-control','placeholder' => trans('general.example') .'physicaldeliveryofficename', $setting->demoMode])); ?>
                       ...
                       <?php endif; ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('custom_forgot_pass_url') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                <?php echo e(Form::text('custom_forgot_pass_url', Request::old('custom_forgot_pass_url', $setting->custom_forgot_pass_url), ['class' => 'form-control','placeholder' => trans('general.example') .'https://my.ldapserver-forgotpass.com', $setting->demoMode])); ?>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/settings/ldap.blade.php ENDPATH**/ ?>
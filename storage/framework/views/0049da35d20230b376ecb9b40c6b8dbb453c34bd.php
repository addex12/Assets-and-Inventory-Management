<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin/settings/general.asset_tag_title')); ?>
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <div class="panel box box-default">
                <div class="box-header with-border">
                    <h2 class="box-title">
                        <i class="fas fa-list-ol"></i> <?php echo e(trans('general.asset_tags')); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group">
                            <div class="col-md-5">
                                <strong><?php echo e(trans('admin/settings/general.auto_increment_assets')); ?></strong>
                            </div>
                            <div class="col-md-7">
                                <label class="form-control">
                                    <?php echo e(Form::checkbox('auto_increment_assets', '1', old('auto_increment_assets', $setting->auto_increment_assets),array('aria-label'=>'auto_increment_assets'))); ?>

                                    <?php echo e(trans('admin/settings/general.enabled')); ?>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/settings/asset_tags.blade.php ENDPATH**/ ?>
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.status == 'success') {
                        ...
                        $("#mailteststatus").html('<i class="fas fa-check text-success"></i> Mail sent to <?php echo e(config('mail.from.address')); ?>!');
                    } else {
...
<?php echo $__env->make('layouts/setup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/setup/index.blade.php ENDPATH**/ ?>
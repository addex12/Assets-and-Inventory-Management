...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title"><?php echo e(trans('admin/suppliers/table.create')); ?></h2>
        </div>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/modals/supplier.blade.php ENDPATH**/ ?>
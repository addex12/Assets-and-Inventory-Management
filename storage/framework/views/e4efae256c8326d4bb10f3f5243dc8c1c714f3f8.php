<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin/settings/general.general_title')); ?>
               ...
               <div class="box-body">
                   ...
                   <div class="col-md-12">
                    ...
                    <div class="form-group <?php echo e($errors->has('full_multiple_companies_support') ? 'error' : ''); ?>">
                        <div class="col-md-3">
                            <strong><?php echo e(trans('admin/settings/general.full_multiple_companies_support_text')); ?></strong>
                        </div>
                        <div class="col-md-9">
                            <label class="form-control">
                                <?php echo e(Form::checkbox('full_multiple_companies_support', '1', old('full_multiple_companies_support', $setting->full_multiple_companies_support),array('aria-label'=>'full_multiple_companies_support'))); ?>
                    ...
                    <div class="form-group <?php echo e($errors->has('require_accept_signature') ? 'error' : ''); ?>">
                        <div class="col-md-3">
                           <strong> <?php echo e(trans('admin/settings/general.require_accept_signature')); ?></strong>
                        </div>
                        <div class="col-md-9">
                            <label class="form-control">
                                <?php echo e(Form::checkbox('require_accept_signature', '1', Request::old('require_accept_signature', $setting->require_accept_signature))); ?>
                    ...
                    <div class="form-group <?php echo e($errors->has('username_format') ? 'error' : ''); ?>">
                       ...
                       <div class="form-group <?php echo e($errors->has('show_images_in_email') ? 'error' : ''); ?>">
                           <div class="col-md-3">
                               <strong><?php echo e(trans('admin/settings/general.show_images_in_email')); ?></strong>
                           </div>
                           <div class="col-md-9">
                               <label class="form-control">
                                   <?php echo e(Form::checkbox('show_images_in_email', '1', old('show_images_in_email', $setting->show_images_in_email))); ?>
                       ...
                       <div class="form-group">
                           <div class="col-md-3">
                               <strong><?php echo e(trans('admin/settings/general.unique_serial')); ?></strong>
                           </div>
                           <div class="col-md-9">
                               <label class="form-control">
                    ...
                    <div class="form-group <?php echo e($errors->has('login_note') ? 'error' : ''); ?>">
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-md-9" id="mailtestrow">
                               <a class="btn btn-default btn-sm pull-left" id="mailtest" style="margin-right: 10px;">
                                   <?php echo e(trans('admin/settings/general.mail_test')); ?></a>
                           ...
                           <div class="col-md-9 col-md-offset-3">
                               <div class="help-block">
                                   <p><?php echo e(trans('admin/settings/general.mail_test_help', array('replyto' => config('mail.reply_to.address')))); ?></p>
                               </div>
                           </div>
                       ...
                       <div class="form-group <?php echo e($errors->has('show_archived_in_list') ? 'error' : ''); ?>">
                           ...
                           <div class="col-md-9">
                                   ...
                                   <label class="form-control">
                                       <?php echo e(Form::checkbox('show_archived_in_list', '1', old('show_archived_in_list', $setting->show_archived_in_list),array('aria-label'=>'show_archived_in_list'))); ?>
                       ...
                       <div class="form-group <?php echo e($errors->has('show_in_model_list') ? 'error' : ''); ?>">
                           <div class="col-md-3">
                               <strong><?php echo e(trans('admin/settings/general.show_in_model_list')); ?></strong>
                           </div>
                           <div class="col-md-9">
                               <label class="form-control">
                               <?php echo e(Form::checkbox('show_in_model_list[]', 'image', old('show_in_model_list', $snipeSettings->modellistCheckedValue('image')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' ))); ?> <?php echo e(trans('general.image')); ?>

                               </label>
                               <label class="form-control">
                               <?php echo e(Form::checkbox('show_in_model_list[]', 'category', old('show_in_model_list', $snipeSettings->modellistCheckedValue('category')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' ))); ?> <?php echo e(trans('general.category')); ?>

                               </label>
                               <label class="form-control">
                               <?php echo e(Form::checkbox('show_in_model_list[]', 'manufacturer', old('show_in_model_list', $snipeSettings->modellistCheckedValue('manufacturer')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' ))); ?>  <?php echo e(trans('general.manufacturer')); ?> </label>
                               <label class="form-control">
                               <?php echo e(Form::checkbox('show_in_model_list[]', 'model_number', old('show_in_model_list', $snipeSettings->modellistCheckedValue('model_number')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' ))); ?> <?php echo e(trans('general.model_no')); ?>
                       ...
                       <!-- dash chart -->
                       <div class="form-group <?php echo e($errors->has('dash_chart_type') ? 'error' : ''); ?>">
                           <div class="col-md-3">
                           ...
                           <div class="col-md-9">
                               <?php echo e(Form::select('dash_chart_type', array(
...
<?php $__env->startSection('moar_scripts'); ?>
    ...
    <script nonce="<?php echo e(csrf_token()); ?>">
        ...
        $("#mailtest").click(function(){
            ...
            $("#mailtesticon").html('<i class="fas fa-spinner spin"></i> <?php echo e(trans('admin/settings/message.mail.sending')); ?>');
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.message) {
                        ...
                        $("#mailteststatus").html('<i class="fas fa-check text-success"></i> <?php echo e(trans('admin/settings/message.mail.success')); ?>');
                    }
                },
                ...
                error: function (data) {
                    ...
                    $('#mailteststatus').html('<?php echo e(trans('admin/settings/message.mail.error')); ?>');
                    if (data.responseJSON) {
                        if (data.responseJSON.messages) {
                            $('#mailteststatus-error').html('Error: ' + data.responseJSON.messages);
                        } else {
                            $('#mailteststatus-error').html('<?php echo e(trans('admin/settings/message.mail.additional')); ?>');
                        }
                    } else {
                        console.dir(data);
                    }
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/settings/general.blade.php ENDPATH**/ ?>
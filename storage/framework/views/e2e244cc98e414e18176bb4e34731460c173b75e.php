    ...
    <head>
      <title>
        <?php $__env->startSection('title'); ?>
         FIS Inventory System <?php echo e(trans('general.setup')); ?>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-10 col-lg-offset-1">
                    <h1 class="page-header">FIS Inventory <?php echo e(trans('general.pre_flight')); ?></h1>
                  </div>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/layouts/setup.blade.php ENDPATH**/ ?>
<div id="assigned_user" class="form-group<?php echo e($errors->has($fieldname) ? ' has-error' : ''); ?>"<?php echo (isset($style)) ? ' style="'.e($style).'"' : ''; ?>>
    ...
    <div class="col-md-7<?php echo e(((isset($required)) && ($required=='true')) ? ' required' : ''); ?>">
        <select class="js-data-ajax" data-endpoint="users" data-placeholder="<?php echo e(trans('general.select_user')); ?>" name="<?php echo e($fieldname); ?>" style="width: 100%" id="assigned_user_select" aria-label="<?php echo e($fieldname); ?>">
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/partials/forms/edit/user-select.blade.php ENDPATH**/ ?>
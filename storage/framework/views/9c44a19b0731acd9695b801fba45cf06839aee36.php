  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-teal">
      <div class="inner">
        ...
        <p><?php echo e(strtolower(trans('general.assets'))); ?></p>
      </div>
      <div class="icon" aria-hidden="true">
        <i class="fas fa-barcode" aria-hidden="true"></i>
      </div>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Asset::class)): ?>
        <a href="<?php echo e(route('hardware.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      <?php endif; ?>
    </div>
      </a>
  </div><!-- ./col -->
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-maroon">
      <div class="inner">
        ...
        <p><?php echo e(strtolower(trans('general.licenses'))); ?></p>
      </div>
      <div class="icon" aria-hidden="true">
        <i class="far fa-save"></i>
      </div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', \App\Models\License::class)): ?>
          <a href="<?php echo e(route('licenses.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
        <?php endif; ?>
    </div>
     </a>
  </div><!-- ./col -->
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-orange">
      <div class="inner">
        ...
        <p><?php echo e(strtolower(trans('general.accessories'))); ?></p>
      </div>
      <div class="icon" aria-hidden="true">
        <i class="far fa-keyboard"></i>
      </div>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Accessory::class)): ?>
          <a href="<?php echo e(route('accessories.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      <?php endif; ?>
    </div>
      </a>
  </div><!-- ./col -->
  ...
  <div class="col-lg-2 col-xs-6">
    ...
    <div class="small-box bg-purple">
      <div class="inner">
        ...
        <p><?php echo e(strtolower(trans('general.consumables'))); ?></p>
      </div>
      <div class="icon" aria-hidden="true">
        <i class="fas fa-tint"></i>
      </div>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Consumable::class)): ?>
        <a href="<?php echo e(route('consumables.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      <?php endif; ?>
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-lg-2 col-xs-6">
   ...
   <div class="small-box bg-yellow">
     <div class="inner">
       ...
       <p><?php echo e(strtolower(trans('general.components'))); ?></p>
     </div>
     <div class="icon" aria-hidden="true">
       <i class="far fa-hdd"></i>
     </div>
       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', \App\Models\License::class)): ?>
         <a href="<?php echo e(route('components.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
       <?php endif; ?>
   </div>
    </a>
 </div><!-- ./col -->
 ...
 <div class="col-lg-2 col-xs-6">
   ...
   <div class="small-box bg-light-blue">
     <div class="inner">
       ...
       <p><?php echo e(strtolower(trans('general.people'))); ?></p>
     </div>
     <div class="icon" aria-hidden="true">
       <i class="fas fa-users"></i>
     </div>
       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', \App\Models\License::class)): ?>
         <a href="<?php echo e(route('users.index')); ?>" class="small-box-footer"><?php echo e(trans('general.view_all')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
       <?php endif; ?>
   </div>
    </a>
 </div><!-- ./col -->

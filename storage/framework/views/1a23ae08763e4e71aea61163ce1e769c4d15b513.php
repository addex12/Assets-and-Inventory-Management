        ...
        <div class="modal-body">
            <form action="<?php echo e(route('api.models.store')); ?>" onsubmit="return false">
                ...
                <div class="dynamic-form-row">
                    ...
                    <div class="col-md-8 col-xs-12"><?php echo e(Form::select('fieldset_id', Helper::customFieldsetList(),Request::old('fieldset_id'), array('class'=>'select2', 'id'=>'modal-fieldset_id', 'style'=>'width:350px'))); ?></div>
                </div>
        </div>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/modals/model.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo e(($snipeSettings) && ($snipeSettings->site_name) ? $snipeSettings->site_name : 'FIS Inventory'); ?></title>
...
<body class="hold-transition login-page">
    ...
    <?php if(($snipeSettings) && ($snipeSettings->logo!='')): ?>
        <center>
            <a href="<?php echo e(config('app.url')); ?>"><img id="login-logo" src="<?php echo e(Storage::disk('public')->url('').e($snipeSettings->logo)); ?>"></a>
        </center>
    <?php endif; ?>
  <!-- Content -->
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/layouts/basic.blade.php ENDPATH**/ ?>
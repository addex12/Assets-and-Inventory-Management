    ...
    <div class="col-md-9<?php echo e((Helper::checkIfRequired($item, 'min_amt')) ? ' required' : ''); ?>">
       <div class="col-md-2" style="padding-left:0px">
            ...
            <div class="col-md-7" style="margin-left: -15px;">
                <a href="#" data-tooltip="true" title="<?php echo e(trans('general.min_amt_help')); ?>"><i class="fas fa-info-circle" aria-hidden="true"></i>
...
<?php /**PATH /home2/flipperschool/inventory.flipperschool.com/resources/views/partials/forms/edit/minimum_quantity.blade.php ENDPATH**/ ?>
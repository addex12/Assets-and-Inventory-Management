...
return [
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import assets, accessories, licenses, components, consumables, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones in the new">sample CSVs in the documentation</a>.',
    ...
    'webhook_test_msg'        => 'Oh hai! Looks like your :app integration with Flipper Inventory is working!',

...
<head>
    {{-- Header Image --}}
<img class="header-img" style="margin-bottom: 50px;top: 0;" src="{{ config('app.url') }}/uploads/FISFAIM.png" style="width: 1176px; height: 88px;">
...
<!----<div style="display: flex; justify-content: flex-end;">
    <img class="header-img" src="{{ config('app.url') }}/uploads/stamp.png" style="width: 190px; height: 200px; border-radius: 50%;">
</div> --->
{{-- Javascript files --}}
